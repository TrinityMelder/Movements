...
# Simulating idle state and then smooth up-and-down head waving on Y-axis
to_send = [
...
positiony_max = 2800  # Less extreme upward movement
...
while time.time() - start_time < duration:
    send_data([[positionx_idle, 3100, 2800, 800], 300])  # Smoother upward (Y-axis)
    send_data([[positionx_idle, 3200, 2000, 800], 300])  # Smoother downward (Y-axis)

print("20 seconds of smoother movement completed.")
